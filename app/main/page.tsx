    ...
    export default function Main() {
        ...
        const handleSubmit = async (e: React.FormEvent) => {
            ...
            const { data, error } = await supabase
                .from('pendaftaran')
                .insert([{ email_pendaftar:email,nama_lengkap: nama, kelas: kelas,alamat: alamat, nomor_telepon: telepon}])
            ...
            if (error) {
                ...
                alert("Daftar berhasil, akan kami hubungi melalui Whatsapp")
